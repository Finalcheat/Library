...
RenewBookWidget::RenewBookWidget(const QString &u, QWidget *parent) :
...
void RenewBookWidget::displayClicked()
{
...
void RenewBookWidget::initModel()
{
...
void RenewBookWidget::queryClicked()
{
...
void RenewBookWidget::renewClicked()
{
...
QString RenewBookWidget::getModelData()
{
    QString str;
...
QString RenewBookWidget::getHeaderDate()
{
    QString str;
